import { X, Calendar, MapPin, Tag, Clock, User, CheckCircle, PlayCircle, MessageSquare, FileText, AlertCircle } from 'lucide-react';
...
export function OfficerIssueModal({ issue, onClose, onStatusUpdate, officerRole }) {
  ...
  function handleStartWork() {
    ...
    setStartWorkData({ estimatedTime: '', teamAssigned: '', plannedApproach: '' });
  }
  ...
  const roleTitle = officerRole === 'ward_officer' ? 'Ward Officer' : 'Field Officer';
      ...
      <div className="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        <div className="sticky top-0 bg-gradient-to-r from-teal-600 to-emerald-700 text-white p-6 flex justify-between items-start rounded-t-xl z-10">
          <div>
            ...
            <p className="text-teal-100 text-sm mt-1 font-mono">{issue.ticket_id}</p>
          </div>
          <button
            onClick={onClose}
          ...
          {activeTab === 'details' && (
            <>
              {(canStart || canComplete) && (
                <div className="bg-gradient-to-r from-teal-50 to-emerald-50 border border-teal-200 rounded-xl p-5">
                  <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                    {officerRole === 'ward_officer' ? '🏛️' : '🔧'} {roleTitle} Actions
                  </h3>
                        ...
                        <div className="space-y-3">
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => setStartWorkData({...startWorkData, estimatedTime: e.target.value})}
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => setStartWorkData({...startWorkData, teamAssigned: e.target.value})}
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              onChange={(e) => setStartWorkData({...startWorkData, plannedApproach: e.target.value})}
                    ...
                    <div className="space-y-4">
                      <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
                        ...
                        <div className="space-y-3">
                          <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                              <span className="text-red-500">*</span> Work Completed (Required)
                            </label>
                            <textarea
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => setCompletionData({...completionData, teamSize: e.target.value})}
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => setCompletionData({...completionData, estimatedDuration: e.target.value})}
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              onChange={(e) => setCompletionData({...completionData, additionalNotes: e.target.value})}
                        ...
                        {!completionData.workDone.trim() && (
                          <div className="flex items-start gap-2 mt-3 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                            ...
                            <p className="text-sm text-amber-800">
                              Please describe the work completed before submitting
                            </p>
                          </div>
                        )}
                  ...
                  {!canStart && !canComplete && (
                    <div className="bg-emerald-100 border border-emerald-300 rounded-lg p-4 text-center">
                      <CheckCircle size={24} className="inline text-emerald-600 mb-2" />
                      <p className="text-emerald-800 font-medium">This issue has been completed</p>
                    </div>
                  )}
                </div>
              )}
              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <div className={`flex items-center text-sm px-3 py-2 rounded-full font-medium ${
                  issue.severity === 'high'
              ...
              {issue.address && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-start text-sm text-blue-900">
                    <MapPin size={20} className="mr-2 mt-1 flex-shrink-0 text-blue-600" />
                    <div>
              ...
              {issue.reporter && (
                <div className="flex items-center text-sm text-gray-600 bg-gray-50 p-3 rounded-lg">
                  ...
                  <span>Reported by: <span className="font-medium">{issue.reporter.full_name}</span></span>
                </div>
              )}
              ...
              {issue.upvotes > 0 && (
                <div className="bg-gradient-to-r from-orange-50 to-amber-50 border border-orange-200 rounded-lg p-4">
                  <p className="text-orange-800 font-medium">
                    👍 {issue.upvotes} {issue.upvotes === 1 ? 'citizen has' : 'citizens have'} upvoted this issue
                  </p>
                </div>
              )}
            </>
