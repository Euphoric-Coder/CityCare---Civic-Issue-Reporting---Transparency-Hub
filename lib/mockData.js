...
export const mockIssues = [
  {
    ...
    description:
      "There is a dangerous pothole near the intersection of Main St and 5th Ave. It has been causing problems for vehicles and needs urgent attention.",
    category: "road",
    status: "in_progress",
    severity: "high",
    priority_score: 32.5,
  ...
  },
  {
    ...
    description:
      "The streetlight at Park Avenue has been out for over a week, making the area unsafe at night.",
    category: "lighting",
    status: "resolved",
    severity: "medium",
    priority_score: 22.3,
  ...
  },
  {
    ...
    description:
      "Multiple garbage bins on Elm Street have been overflowing for days. This is attracting pests and creating an unsanitary environment.",
    category: "waste",
    status: "pending",
    severity: "high",
    priority_score: 28.7,
  ...
  },
  {
    ...
    description:
      "Noticed a water leak near the fountain in Central Park. Water is continuously flowing and being wasted.",
    category: "water",
    status: "in_progress",
    severity: "medium",
    priority_score: 19.5,
  ...
  },
  {
    ...
    description:
      "Cracked and uneven sidewalk creating a tripping hazard for pedestrians.",
    category: "road",
    status: "pending",
    severity: "low",
    priority_score: 12.8,
  ...
  },
  {
    ...
    description:
      "Offensive graffiti on the community center wall needs to be removed.",
    category: "other",
    status: "resolved",
    severity: "low",
    priority_score: 11.2,
  ...
  },
  {
    ...
    description:
      "The stop sign at Broadway and 8th Street is badly damaged and barely visible. This is a serious safety hazard.",
    category: "road",
    status: "pending",
    severity: "high",
    priority_score: 30.2,
  ...
  },
  {
    ...
    description:
      "One of the benches near the playground has broken slats. Could be dangerous for children.",
    category: "other",
    status: "in_progress",
    severity: "medium",
    priority_score: 16.5,
    upvotes: 6,
    photo_url:
      "https://images.pexels.com/photos/2305165/pexels-photo-2305165.jpeg?auto=compress&cs=tinysrgb&w=800",
    latitude: 40.7957,
    longitude: -73.9389,
  ...
  },
  {
    ...
    description:
      "Fire hydrant on Madison Avenue is continuously leaking water, creating a puddle on the sidewalk.",
    category: "water",
    status: "pending",
    severity: "medium",
    priority_score: 21.4,
  ...
  },
  {
    ...
    description:
      "Dangerous open manhole on Washington Street. Immediate attention required to prevent accidents.",
    category: "road",
    status: "in_progress",
    severity: "high",
    priority_score: 45.8,
  ...
  },
  {
    ...
    description:
      "Multiple streetlights along 3rd Avenue are flickering constantly. Very annoying and potentially dangerous.",
    category: "lighting",
    status: "pending",
    severity: "low",
    priority_score: 14.3,
  ...
  },
  {
    ...
    description:
      "Large amount of construction debris dumped illegally near the apartment complex on Greene Street.",
    category: "waste",
    status: "resolved",
    severity: "medium",
    priority_score: 24.6,
  ...
  },
  {
    ...
    description:
      "Large cracks in the pavement at the pedestrian crossing on Lexington Avenue. Wheelchair users are having difficulty crossing safely.",
    category: "road",
    status: "pending",
    severity: "high",
    priority_score: 33.7,
  ...
  },
  {
    ...
    description:
      "Traffic light at the intersection of 5th Avenue and 42nd Street is not working properly. Red light stays on for too long causing traffic congestion.",
    category: "other",
    status: "in_progress",
    severity: "high",
    priority_score: 41.2,
  ...
  },
  {
    ...
    description:
      "The lights at the entrance to the 7th Avenue subway station have been out for over two weeks. Very dark and unsafe at night.",
    category: "lighting",
    status: "pending",
    severity: "high",
    priority_score: 36.4,
  ...
  },
  {
    ...
    description:
      "All recycling bins at Battery Park are completely full and overflowing. Recyclables are spilling onto the ground.",
    category: "waste",
    status: "in_progress",
    severity: "medium",
    priority_score: 20.8,
  ...
  },
  {
    ...
    description:
      "The water fountain on the second floor of the public library has been broken for months. Not dispensing any water.",
    category: "water",
    status: "pending",
    severity: "low",
    priority_score: 9.3,
  ...
  },
  {
    ...
    description:
      "The slide in the children's playground at Hudson River Park is damaged with sharp edges. Needs immediate repair for safety.",
    category: "other",
    status: "in_progress",
    severity: "high",
    priority_score: 38.9,
  ...
  },
  {
    ...
    description:
      "A large tree branch has fallen and is blocking the entire sidewalk on Amsterdam Avenue after the recent storm.",
    category: "other",
    status: "resolved",
    severity: "high",
    priority_score: 42.1,
  ...
  },
  {
    ...
    description:
      "The white stripes of the pedestrian crossing on Houston Street are completely faded and barely visible. Dangerous for pedestrians.",
    category: "road",
    status: "pending",
    severity: "medium",
    priority_score: 25.3,
  ...
  },
  {
    ...
    description:
      "The lock on the public restroom at Union Square is broken. Door won't stay closed creating privacy and safety issues.",
    category: "other",
    status: "pending",
    severity: "medium",
    priority_score: 18.7,
